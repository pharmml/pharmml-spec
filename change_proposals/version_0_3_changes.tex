...
the \xelem{TrialDesign} part is in such case redundant which simplifies the encoding of such model.
Table \ref{tab:withAndWithoutNM} below summarises the differences.
\begin{table}[ht!]
\begin{center}
\begin{tabular}{ll}
  \hline
...
\\
    \hline
\end{tabular}
\caption{Comparison of model structures encoded using \xelem{TrialDesign} (left) versus using NONMEM format dataset (right).}
