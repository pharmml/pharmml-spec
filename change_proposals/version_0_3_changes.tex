...
\lstdefinelanguage{XML}
{
  ...
  math,ct,ds,mdef,mstep,mml,un,name,definition,writtenVersion,id,inputType} % list your attributes here
}
...
This document describes changes and extension to the 0.2.1 version of PharmML \cite{Pharmml_021}.
...
such as \xelem{CovariateModel} or \xelem{ObservationModel}
\lstset{language=XML}
\begin{lstlisting}
<!-- MODELLING STEPS -->
...
external tool datasets for which support is very limited and their needs underspecified.
...
\emph{interp1:1-D data interpolation (table lookup)}'  \url{http://www.mathworks.co.uk/help/matlab/ref/interp1.html}. Additionally the \emph{constant} algorithm type is supported.}. In case \emph{C2} the interpolation 
