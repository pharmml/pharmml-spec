...
\lstdefinelanguage{XML}
{
  ...
  morekeywords={oid,columnId,columnIdRef,symbId,symbolType,op,columnNum,columnType,valueType,inputTarget,
  blkId,blkIdRef,symbIdRef,xmlns,version,type,VariableMapping,IndividualMapping, NONMEMdataSet,matrixType,opType,order,
  name,definition} % list your attributes here
}
...
trial. The rate of steady state infusion (R1) was calculated from: R1 = CL Ѕ Css\_pre". 
...
correlation between corresponding random effects. The version 0.3 offers additionally a 
...
A possibility of specifying one of five standard interpolation algorithms is provided, {constant, 
linear, spline, pchip, cubic}, as defined in MATLAB, http://www.mathworks.co.uk/help/matlab/ref/interp1.html
...
\subsection{Multiple random errors allowed in the Gaussian model}
